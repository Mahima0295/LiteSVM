...
public class Tests {
    ...
    @Test
    public void testHorizontalLineSamplesWithDefaultSetting() throws Exception {
        ...
        final BinaryClassifier classifier = LiteSVM.trainBinaryClassifier(samples);
    ...
    @Test
    public void testVerticalLineSamplesWithDefaultSetting() throws Exception {
